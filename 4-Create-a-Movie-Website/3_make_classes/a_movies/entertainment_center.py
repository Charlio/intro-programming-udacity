...
gladiator = media.Movie("Gladiator",
                        "A man robbed of his name and dignity strives to win them back and gain the freedom of his people",
                        "https://upload.wikimedia.org/wikipedia/en/8/8d/Gladiator_ver1.jpg",
                        "https://www.youtube.com/watch?v=owK1qxDselE")  
 
alien = media.Movie("Alien", 
                    "A close encounter of the third kind becomes a Jaws-style nightmare when an alien invades a spacecraft",
                    "https://upload.wikimedia.org/wikipedia/en/f/fb/Aliens_poster.jpg",
                    "https://www.youtube.com/watch?v=LjLamj-b0I8") 
                    
pacific_rim = media.Movie("Pacific Rim",
                          "A ragtag band of humans banding together to fight monstrous creatures from the sea",
...
the_day_after_tomorrow = media.Movie("The Day after Tomorrow",
                                     "A paleoclimatologist must reach his son trapped in a sudden international storm",
                                     "https://upload.wikimedia.org/wikipedia/en/5/58/The_Day_After_Tomorrow_movie.jpg",
                                     "https://www.youtube.com/watch?v=Ku_IseK3xTc")
                     
deep_impact = media.Movie("Deep Impact",
                          "Humans attempt to destroy a comet expected to collide with the Earth and cause a mass extinction",
                          "https://upload.wikimedia.org/wikipedia/en/9/93/Deep_Impact_poster.jpg",
                          "https://www.youtube.com/watch?v=NTkfk4dCnu8")
                     
movies = [kingdom_of_heaven, gladiator, alien, pacific_rim, the_day_after_tomorrow, deep_impact]
